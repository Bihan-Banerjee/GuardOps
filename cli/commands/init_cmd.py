...
def init_command(name, cloud, namespace, force):
    ...
    steps = [
        ...
        "   [bold green]guardops deploy[/bold green]",
        "4. Check deployment status:",
        "   [bold green]guardops status[/bold green]",
    ]
    for step in steps:
...
def _create_sample_dockerfile_if_missing(project_name: str) -> None:
    ...
    dockerfile_content = '''# Generated by GuardOps init
...
'''
    ...
    info("Created sample [cyan]Dockerfile[/cyan] — replace with your app's Dockerfile")
